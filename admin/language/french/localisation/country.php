...
Pr&eacute;nom = {firstname}<br />
Nom = {lastname}<br />
Soci&eacute;t&eacute; = {company}<br />
Adresse = {address_1}<br />
Compl&eacute;ment d&#8217;adresse 2 = {address_2}<br />
Ville = {city}<br />
Code postal = {postcode}<br />
D&eacute;partement = {zone}<br />
Code d&eacute;partement = {zone_code}<br />
Pays = {country}</span>';
