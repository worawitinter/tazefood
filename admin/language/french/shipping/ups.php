...
$_['entry_weight_code']				= 'Code de poids :<br /><span class="help">Entrer le code poids en kgs ou livres (lbs). Assurez-vous d&#8217;utiliser le m&ecirc;me classe de poids que code poids UPS.</span>';
$_['entry_weight_class']			= 'Classe de poids :<span class="help">Selectionner kgs ou livres (lbs).</span>';
$_['entry_length_code']				= 'Code des longueurs :<br /><span class="help">Assurez-vous que cela corresponde &agrave; la classe et au code de mesure</span>';
