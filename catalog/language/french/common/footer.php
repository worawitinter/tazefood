...
$_['text_powered']		= 'D&eacute;velopp&eacute; Par <a href="http://www.opencart.com" onclick="window.open(this.href)">OpenCart</a><br />Propuls&eacute; Par <a href="http://www.opencart-france.com" onclick="window.open(this.href)">OpenCart France</a><br /> %s &copy; %s';
?>